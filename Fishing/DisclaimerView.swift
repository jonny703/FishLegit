...
class DisclaimerView: UIView {
    ...
    class func initWith(title: String, filePath: String? = nil, fileExtension: String? = nil, content: String = "", cancelTitle: String = "I Disagree", acceptTitle: String = "I Agree", frame: CGRect = UIScreen.main.bounds, delegate: DisclaimerViewDelegate) -> DisclaimerView {
        
        let disclaimerView = UINib(nibName: "Disclaimer", bundle: nil).instantiate(withOwner: nil, options: nil)[0] as! DisclaimerView
        
        disclaimerView.title.text = title
        disclaimerView.title.textColor = .black
...
//        disclaimerView.cancelButton.borders(for: [.top, .right], color: .init(colorLiteralRed: 0.9, green: 0.9, blue: 0.9, alpha: 1))
        disclaimerView.cancelButton.borders(for: [.top, .right], color: UIColor.black)
        disclaimerView.acceptButton.borders(for: [.top], color: StyleGuideManager.signinButtonColor)
